...
MARKER_SIZE_METERS = 0.1577 # Physical side length of the square markers

# Reference Marker settings
REFERENCE_MARKER_ID = 0 # remember to change this!
...
NUM_BUOYS = 9
MARKERS_PER_BUOY = 3 # Assumes 3 markers per buoy for triangular geometry
