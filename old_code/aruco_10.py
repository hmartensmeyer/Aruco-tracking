...
- LED Synchronization: Can monitor a user-defined region of the video
  for a red LED turning on/off, logging its state (1 or 0) in the data file
  to synchronize with external measurements. Supported for both live and offline modes.
- Data Logging: Saves detailed tracking data (timestamp, pose, quaternion, LED state) to
...
- Visualization:
    - Overlays buoy axes, CoG, trajectories, and LED status directly on the video feed.
...
Author: Paul FROMONT
Date: 17/06/2025
Version: 1.1 (LED Sync Fix & Offline Support)
...
class SettingsDialog(tk.Toplevel):
    ...
    def apply_settings(self):
        ...
        initialize_buoy_configs(); messagebox.showinfo("Settings Applied","Settings updated.",parent=self); self.destroy()
