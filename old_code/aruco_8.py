...
# %% ===========================================================================
# CORE FRAME PROCESSING LOGIC (REFACTORED)
# =============================================================================
...
def _process_frame_common(
    ...
    by both live and offline processing modes. It performs ArUco marker detection,
    fuses poses for each buoy, calculates the Center of Gravity (CoG) pose,
    transforms poses to a reference frame if enabled, generates data for
    logging, and prepares data for visualization overlays and plots.
    ...
    Args:
        ...
        positions_history (dict): Dictionary to store trajectory data.
        log_date_str, log_time_str (str): Timestamp strings for logging.
        timestamp (float): The numeric timestamp of the frame for plotting.
        buoy_id_to_marker_ids_map_param (dict): Map of buoy IDs to marker IDs.
        marker_buoy_geometry_config_param (dict): Configuration for marker geometry on buoys.
        buoy_cog_offsets_in_brf_config_param (dict): Configuration for CoG offsets.
...
# %% ===========================================================================
# TOP-LEVEL APPLICATION MODES (REFACTORED)
# =============================================================================
...
class BuoyTrackerApp:
    ...
    def __init__(self, master):
        ...
        try:
            icon_image = tk.PhotoImage(file='aruco_icon.png')
            master.iconphoto(True, icon_image)
        except tk.TclError:
            print("Warning: 'app_icon2.png' not found. Using default icon.")
